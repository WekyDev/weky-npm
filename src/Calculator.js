...
module.exports = async (options) => {
	...
	let str = ' ';
	let stringify = '```\n' + str + '\n```';
	const calc_irrc = "12345678901234567001";
	const empty_irrc = "12345678901234567002" ;
	const calc_percent = "12345678901234567003";
	const calculator_7 = "12345678901234567004" ;
	const calculator_8 = "12345678901234567005" ;
	const calculator_9 = "12345678901234567006" ;
	const calculator_1 = "12345678901234567007" ;
	const calculator_2 = "12345678901234567008" ;
	const calculator_3 = "12345678901234567009" ;
	const calculator_4 = "12345678901234567010" ;
	const calculator_5 = "12345678901234567011" ;
	const calculator_0 = "12345678901234567012" ;
	const calculator_6 = "12345678901234567013" ;
	const calculator_e1 = "12345678901234567014" ;
	const calculator_e2 = "12345678901234567015" ;
	const calculator_dot = "12345678901234567016" ;
	const calculator_plus = "12345678901234567017" ;
	const calculator_star = "12345678901234567018" ;
	const calculator_equal = "12345678901234567019" ;
	const calculator_clear = "12345678901234567020" ;
	const calculator_minus = "12345678901234567021" ;
	const calculator_devide = "12345678901234567022" ;
	const calculator_backspace = "12345678901234567023" ;
	const calculator_uppercase = "12345678901234567024" ;
	...
	options.message.channel.send(embed).then(async (msg) => {
		msg.edit({
			...
			components: [
				...
				{
					type: 1,
					components: [dot, zero, equal, plus, empty.setID("22345678901234567002")],
				},
			],
		});
		async function edit() {
